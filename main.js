...
const knownDeviceType = {
    ...
    'A1BVM8W970VMG3':   {name: 'Samsung Soundbar Q 2025', commandSupport: true}, // MICROPHONE,CUSTOM_ALARM_TONE,GOLDFISH,TIMERS_AND_ALARMS,I_HEART_RADIO,AUDIBLE,SLEEP,DREAM_TRAINING,SET_TIME_ZONE,EQUALIZER_CONTROLLER_MIDRANGE,SUPPORTS_LOCALE_SWITCH,ASCENDING_ALARM_VOLUME,DEEZER,DEREGISTER_DEVICE,FAR_FIELD,CHANGE_NAME,AMAZON_MUSIC,SET_LOCALE,ADAPTIVE_LISTENING,AUDIO_PLAYER,BT_PAIRING_FLOW_V2,REMINDERS,PERSISTENT_CONNECTION,SOUND_SETTINGS,TUNE_IN,SUPPORTS_LOCALE,APPLE_MUSIC,EARCONS,TIMERS_ALARMS_NOTIFICATIONS_VOLUME,VOLUME_SETTING,DIALOG_INTERFACE_VERSION,SUPPORTS_CONNECTED_HOME_CLOUD_ONLY,EQUALIZER_CONTROLLER_BASS,MUSIC_SKILL,MULTI_WAKEWORDS_SUPPORTED,EQUALIZER_CONTROLLER_TREBLE,SPEECH_RECOGNIZER_USS,SIRIUSXM,KINDLE_BOOKS,TIDAL,PAIR_BT_SINK,AUDIO_CONTROLS
    ...
    'A1Q6UGEXJZWJQ0':   {name: 'Fire TV', commandSupport: true, icon: 'icons/firetv.png'}, // SPEECH_RECOGNIZER_USS,ACTIVE_AFTER_FRO,MULTI_WAKEWORDS_SUPPORTED,VOLUME_SETTING,ADAPTIVE_LISTENING,SOUND_SETTINGS,DIALOG_INTERFACE_VERSION,EARCONS,CUSTOM_ALARM_TONE,CHANGE_NAME,TIMERS_AND_ALARMS,LIVE_VIEW,PERSISTENT_CONNECTION,FLASH_BRIEFING,SUPPORTS_LOCALE,ARTHUR_TARGET,SUPPORTS_CONNECTED_HOME_CLOUD_ONLY,REMINDERS,SUPPORTS_LOCALE_SWITCH,MICROPHONE,SHARKNADO,SUPPORTS_SOFTWARE_VERSION
    ...
    'A1WZKXFLI43K86':   {name: 'Fire TV Stick 4K Max (2. Generation)', commandSupport: true, icon: 'icons/firetv.png'}, // MICROPHONE,ACTIVE_AFTER_FRO,LIVE_VIEW,CUSTOM_ALARM_TONE,SOUND_SETTINGS,CHANGE_NAME,SUPPORTS_CONNECTED_HOME_CLOUD_ONLY,SUPPORTS_LOCALE,ADAPTIVE_LISTENING,SHARKNADO,SUPPORTS_LOCALE_SWITCH,PERSISTENT_CONNECTION,FLASH_BRIEFING,SUPPORTS_SOFTWARE_VERSION,VOLUME_SETTING,REMINDERS,TIMERS_AND_ALARMS,MULTI_WAKEWORDS_SUPPORTED,DIALOG_INTERFACE_VERSION,SPEECH_RECOGNIZER_USS,EARCONS,ARTHUR_TARGET
    ...
    'A2O2CEO9STBQID':   {name: 'Echo Studio', commandSupport: true, icon: 'icons/echo_studio.png'}, // SLEEP,ALEXA_NETWORKING,EQUALIZER_CONTROLLER_TREBLE,FLASH_BRIEFING,CUSTOM_ALARM_TONE,EQUALIZER_CONTROLLER_MIDRANGE,AUDIO_CONTROLS,LEMUR_ALPHA,FACE_TO_TALK,WAKE_WORD_SENSITIVITY,SIRIUSXM,PAIR_BT_SINK,SPEECH_RECOGNIZER_USS,DEEZER,SET_LOCALE,AMAZON_MUSIC,ASCENDING_ALARM_VOLUME,I_HEART_RADIO,GUARD_EARCON,MULTI_WAKEWORDS_SUPPORTED,KINDLE_BOOKS,TUPLE_CATEGORY_A,TIDAL,VOLUME_SETTING,ACTIVE_AFTER_FRO,SALMON,AUDIO_PLAYER,PANDORA,DS_VOLUME_SETTING,UPDATE_WIFI,SUPPORTS_CONNECTED_HOME_CLOUD_ONLY,ALEXA_NETWORKING_WIFI,BT_PAIRING_FLOW_V2,TAP_GESTURES_SINGLE_TAP,EARCONS,PERSISTENT_CONNECTION,EQUALIZER_CONTROLLER_BASS,DIALOG_INTERFACE_VERSION,ADAPTIVE_VOLUME,CHANGE_NAME,SET_TIME_ZONE,TAHOE_BYOD,MUSIC_SKILL,REQUIRES_OOBE_FOR_SETUP,SUPPORTS_LOCALE_SWITCH,ADAPTIVE_LISTENING,EFDCARDS,TAP_GESTURES,MOTION_SENSOR_RANGE_STRING,GADGETS,AUDIBLE,FAR_FIELD_WAKE_WORD,ALEXA_PRESENCE,TIMERS_AND_ALARMS,PAIR_BT_SOURCE,POPTART,MICROPHONE,ALEXA_DEVICE_REBOOT,TIMERS_ALARMS_NOTIFICATIONS_VOLUME,TEMPERATURE_SENSOR,ALEXA_VOICE,SUPPORT_CALENDAR_ALERT,TAP_GESTURES_RESUME_MEDIA,REMINDERS,GOLDFISH,SUPPORTS_SOFTWARE_VERSION,TUPLE,APPLE_MUSIC,TUNE_IN,SUPPORTS_LOCALE,DREAM_TRAINING,MOTION_DETECTION,SOUND_SETTINGS,DEREGISTER_DEVICE,VOICE_TRAINING
    ...
    'A3EH2E0YZ30OD6':   {name: 'Echo Spot', commandSupport: true, icon: 'icons/spot.png'}, // REMINDERS,GOLDFISH,TAHOE_BYOD,DS_VOLUME_SETTING,ALEXA_DEVICE_REBOOT,EQUALIZER_CONTROLLER_TREBLE,I_HEART_RADIO,TAP_GESTURES_SINGLE_TAP,TAP_GESTURES,LIVE_VIEW,ASCENDING_ALARM_VOLUME,EQUALIZER_CONTROLLER_BASS,TUPLE_CATEGORY_A,MULTI_WAKEWORDS_SUPPORTED,CHANGE_NAME,ALEXA_NETWORKING,PANDORA,DEVICE_CLOCK_DISPLAY,EARCONS,SUPPORTS_LOCALE_SWITCH,FLASH_BRIEFING,CUSTOM_ALARM_TONE,TIMERS_AND_ALARMS,GUARD_EARCON,DEVICE_COLOR_THEME,ADAPTIVE_LISTENING,AUDIO_PLAYER,MICROPHONE,WAKE_WORD_SENSITIVITY,LEMUR_ALPHA,FAR_FIELD_WAKE_WORD,SUPPORTS_SOFTWARE_VERSION,SUPPORTS_LOCALE,DISPLAY_POWER_TOGGLE,DEREGISTER_DEVICE,SUPPORT_CALENDAR_ALERT,VOICE_TRAINING,KINDLE_BOOKS,DREAM_TRAINING,AUDIBLE,DEVICE_NIGHT_MODE,SOUND_SETTINGS,EFDCARDS,TIMERS_ALARMS_NOTIFICATIONS_VOLUME,BT_PAIRING_FLOW_V2,DIALOG_INTERFACE_VERSION,DEEZER,REQUIRES_OOBE_FOR_SETUP,APPLE_MUSIC,PERSISTENT_CONNECTION,SPEECH_RECOGNIZER_USS,VOLUME_SETTING,ALEXA_PRESENCE,ALEXA_CAPTIONING,DISPLAY_ADAPTIVE_BRIGHTNESS,POPTART,DISPLAY_BRIGHTNESS_ADJUST,SLEEP,PAIR_BT_SINK,SET_LOCALE,TIDAL,ACTIVE_AFTER_FRO,AMAZON_MUSIC,MUSIC_SKILL,EQUALIZER_CONTROLLER_MIDRANGE,SET_TIME_ZONE,SALMON,ALEXA_VOICE,TUNE_IN,UPDATE_WIFI,SIRIUSXM,CLOCK_FORMAT_24_HR,TUPLE,FACE_TO_TALK,COLOR_INVERSION,GADGETS,SUPPORTS_CONNECTED_HOME_CLOUD_ONLY,PAIR_BT_SOURCE,AUDIO_CONTROLS,ALEXA_NETWORKING_WIFI,ADAPTIVE_VOLUME
    ...
    'A3GJ3B7L9P1F5O':   {name: 'Hisense (VIDAA TV)', commandSupport: true}, // LIVE_VIEW,VOLUME_SETTING,TIMERS_ALARMS_NOTIFICATIONS_VOLUME,SET_TIME_ZONE,SET_LOCALE,MULTI_WAKEWORDS_SUPPORTED,ADAPTIVE_LISTENING,I_HEART_RADIO,SUPPORTS_LOCALE_SWITCH,DEEZER,SUPPORTS_LOCALE,MICROPHONE,EARCONS,HANDS_FREE,CUSTOM_ALARM_TONE,SUPPORTS_CONNECTED_HOME_CLOUD_ONLY,TUNE_IN,AUDIBLE,AUDIO_PLAYER,CHANGE_NAME,ASCENDING_ALARM_VOLUME,SPEECH_RECOGNIZER_USS,PERSISTENT_CONNECTION,GOLDFISH,FAR_FIELD,REMINDERS,AMAZON_MUSIC,TIDAL,TOUCH_INITIATED,SOUND_SETTINGS,DREAM_TRAINING,DEREGISTER_DEVICE,KINDLE_BOOKS,APPLE_MUSIC,SIRIUSXM,TIMERS_AND_ALARMS,SLEEP,MUSIC_SKILL,DIALOG_INTERFACE_VERSION
    ...
    'AVN2TMX8MU2YM':    {name: 'Bose Home Speaker', commandSupport: true}, // VOLUME_SETTING,KINDLE_BOOKS,AUDIBLE,ADAPTIVE_LISTENING,SLEEP,DEREGISTER_DEVICE,DEEZER,TIMERS_AND_ALARMS,CHANGE_NAME,SIRIUSXM,APPLE_MUSIC,PERSISTENT_CONNECTION,TIDAL,MUSIC_SKILL,DREAM_TRAINING,AMAZON_MUSIC,I_HEART_RADIO,SUPPORTS_CONNECTED_HOME_CLOUD_ONLY,REMINDERS,GOLDFISH,FAR_FIELD,AUDIO_PLAYER,TUNE_IN
